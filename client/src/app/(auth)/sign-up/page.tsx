      ...
      <Card className="w-full max-w-md border-zinc-800 bg-[#161616] text-white">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription className="text-zinc-400">
            Create an account to declare Fielding Sets.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }: { field: any }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="meme_lord" className="border-zinc-700 bg-zinc-900 text-white" {...field} />
                    </FormControl>
        ...
        <CardFooter className="flex flex-col text-center">
          <div className="text-sm text-zinc-400">
            ...
            <Link href="/sign-in" className="text-[#22c55e] hover:underline">
              Log in
            </Link>
          </div>
        </CardFooter>
